...
schema: v1
rules:
  - "Input: \${{ inputs.userSetting }} | Secret: \${{ secrets.apiKey }} | Xynapse: \${{ Xynapse.workspaceRoot }}"
`;
    ...
    expect(ruleText).toBe(
      "Input: ${{ secrets.userSetting }} | Secret: ${{ secrets.apiKey }} | Xynapse: ${{ Xynapse.workspaceRoot }}",
    );
    ...
    expect(configStr).toContain("Xynapse.workspaceRoot");
  });
