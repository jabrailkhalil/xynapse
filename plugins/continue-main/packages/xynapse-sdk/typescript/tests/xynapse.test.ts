...
import { Xynapse } from "../src/Xynapse.js";

dotenv.config();

/**
 * This test is `.skip`'d for now becasue it requires a real API key
 * and a real assistant to be set up in the Xynapse Hub.
 *
 * The primary use case for now is to aid in local iteration on the SDK.
 */
test.skip("should make a real API call to the Xynapse service", async () => {
