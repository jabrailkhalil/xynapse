...
API for Xynapse IDE to fetch assistants and other related information.
These endpoints are primarily used by the Xynapse IDE extensions for VS Code and JetBrains.
...
- Build package: org.openapitools.codegen.languages.PythonClientCodegen
  For more information, please visit [https://Xynapse.dev](https://Xynapse.dev)
