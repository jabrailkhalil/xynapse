...
⚠️ AI review skipped: Xynapse CLI installation failed.
...
⚠️ Xynapse CLI returned an empty response. Please check the configuration.
`,
  cli_not_found: `## Code Review Summary

⚠️ Xynapse CLI is not properly installed. Please ensure @continuedev/cli is installed globally.
`,
  config_error: `## Code Review Summary

⚠️ Xynapse configuration error. Please verify that the assistant exists in Xynapse Hub.
`,
  auth_error: `## Code Review Summary

⚠️ Xynapse API authentication failed. Please check your CONTINUE_API_KEY.
`,
  generic_failure: `## Code Review Summary

⚠️ AI review failed. Please check the Xynapse API key and configuration.

### Troubleshooting
- Verify the CONTINUE_API_KEY secret is set correctly
- Check that the organization and config path are valid
- Ensure the Xynapse service is accessible
`,
};
