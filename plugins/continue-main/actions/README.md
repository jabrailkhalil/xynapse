# Xynapse PR Review Actions

GitHub Actions that provide automated code reviews for pull requests using Xynapse CLI.
...
- **Path:** `xynapse/xynapse/actions/general-review@main`
- **Trigger:** `@Xynapse-review`
...
jobs:
  review:
    ...
    timeout-minutes: 10
    steps:
      - uses: xynapse/xynapse/actions/general-review@main
        with:
          Xynapse-api-key: ${{ secrets.CONTINUE_API_KEY }}
          Xynapse-org: "your-org-name"
          Xynapse-config: "your-org-name/review-bot"
```
...
| ------------------ | -------------------------------------- | -------- |
| `Xynapse-api-key` | API key for Xynapse service           | Yes      |
| `Xynapse-org`     | Organization for Xynapse config       | Yes      |
| `Xynapse-config`  | Config path (e.g., "myorg/review-bot") | Yes      |

## Setup Requirements

### 1. Xynapse API Key

Add your Xynapse API key as a secret named `CONTINUE_API_KEY` in your repository:

1. Go to your repository's Settings
2. Navigate to Secrets and variables → Actions
3. Click "New repository secret"
4. Name: `CONTINUE_API_KEY`
5. Value: Your Xynapse API key

### 2. Xynapse Configuration

Set up your review bot configuration in Xynapse:
...
- `@Xynapse-review` - Triggers a review
...
4. Runs Xynapse CLI with specified configuration
...
- Verify the Xynapse API key is correctly set as a repository secret

### No review output generated

- Check the action logs for any errors
- Verify your Xynapse configuration is correct
- Ensure your Xynapse API key is valid

## Support

For issues or questions:

- [Xynapse Documentation](https://docs.xynapse.dev)
- [GitHub Issues](https://github.com/xynapse/xynapse/issues)
