...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "xynapse.diffVisible", true);
    ...
    vscode.commands.executeCommand("setContext", "xynapse.streamingDiff", true);
  ...
  async streamEdit({
    ...
    if (existingHandler) {
      ...
      // but extra delta was added for each line generated by Xynapse
      // Before adding this back, we need to distinguish between human and Xynapse
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("xynapse.rejectDiff");
      }
