...
import { XynapseCompletionProvider } from "../completionProvider";
...
describe("XynapseCompletionProvider triggering logic", () => {
...
function buildProvider(options: { usingFullFileDiff?: boolean } = {}) {
  ...
  const provider = new XynapseCompletionProvider(
    configHandler,
    ide,
    webviewProtocol,
    usingFullFileDiff,
