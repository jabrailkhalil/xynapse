...
async function downloadSqliteBinary(target) {
  ...
  const downloadUrl = {
    "darwin-arm64":
      "https://github.com/TryGhost/node-sqlite3/releases/download/v6.0.1/sqlite3-v6.0.1-napi-v6-darwin-arm64.tar.gz",
    "linux-arm64":
      "https://github.com/TryGhost/node-sqlite3/releases/download/v6.0.1/sqlite3-v6.0.1-napi-v6-linux-arm64.tar.gz",
    "win32-arm64":
    ...
    "darwin-x64":
      "https://github.com/TryGhost/node-sqlite3/releases/download/v6.0.1/sqlite3-v6.0.1-napi-v6-darwin-x64.tar.gz",
    "win32-x64":
      "https://github.com/TryGhost/node-sqlite3/releases/download/v6.0.1/sqlite3-v6.0.1-napi-v6-win32-x64.tar.gz",
  }[target];
  execCmdSync(
