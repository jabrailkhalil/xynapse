...
const { buildAndCopyXynapseRuntime } = require("./build-copy-xynapse-runtime");
...
void (async () => {
  ...
  if (fs.existsSync(indexHtmlPath)) {
    ...
    // Put back the IntelliJ-specific index.html.
    ...
    console.log("[info] Optional IntelliJ extension not present; skipping GUI copy");
  }
  ...
  buildAndCopyXynapseRuntime({ target, os, arch, exe });
