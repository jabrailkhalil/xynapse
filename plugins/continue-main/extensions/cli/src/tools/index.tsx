...
export async function getAllAvailableTools(
  ...
  tools.push(...mcpState.tools.map(convertMcpToolToXynapseTool));
...
export function convertMcpToolToXynapseTool(mcpTool: MCPTool): Tool {
  return {
    name: mcpTool.name,
...
export async function executeToolCall(
  ...
  try {
    ...
    const errorReason =
      error instanceof XynapseError
        ? error.reason
        : XynapseErrorReason.Unknown;
