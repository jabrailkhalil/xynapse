# End-to-End Testing for Xynapse CLI

This document describes the principles, practices, and patterns for writing end-to-end (E2E) tests for the Xynapse CLI.
...
expect(result.exitCode).toBe(0);
expect(result.stdout).toContain("Xynapse CLI");
```
