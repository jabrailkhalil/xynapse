...
import { XynapseErrorReason } from "../../../../core/util/errors.js";
import { isHeadlessMode } from "../util/cli.js";
import { isXynapseRemoteAgent, isGitHubActions } from "../util/git.js";
...
class TelemetryService {
  ...
  private initializeMetrics() {
    ...
    // Additional Xynapse CLI specific metrics
  ...
  public recordSessionStart() {
    ...
    const sessionAttributes = this.getStandardAttributes({
      ...
      is_xynapse_remote_agent: isXynapseRemoteAgent().toString(),
    });
  ...
  public logToolResult(options: {
    ...
    durationMs: number;
    error?: string;
    errorReason?: XynapseErrorReason;
    decision?: "accept" | "reject";
    source?: string;
