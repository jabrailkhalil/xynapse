...
describe("TelemetryService - Session Metadata", () => {
  ...
  describe("recordSessionStart", () => {
    ...
    it("should include is_xynapse_remote_agent=true when in remote agent mode", () => {
      // Set Xynapse remote agent environment
