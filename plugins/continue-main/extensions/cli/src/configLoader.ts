...
import { DefaultApiInterface } from "@xynapse/sdk/dist/api/dist/index.js";
...
/**
 * Loads default config.yaml from ~/.xynapse/config.yaml
 */
...
/**
 * Loads an assistant by slug from the Xynapse platform
 */
