# Xynapse anonymous Posthog telemetry

## Behavior

- Used by Xynapse for product metrics (not used by customers)
...
- Event user ids are the Xynapse user id is signed in, or a unique machine id if not
