...
The Xynapse CLI (`cn`) is a customizable command line coding agent.

![Xynapse CLI Demo](./media/demo.gif)
...
- `XYNAPSE_CLI_DISABLE_COMMIT_SIGNATURE`: Disable adding the Xynapse commit signature to generated commit messages
...
- `cn login`: Authenticate with Xynapse
