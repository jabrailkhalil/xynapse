...
function TipTapEditorInner(props: TipTapEditorProps) {
  ...
  // Disable editor when inputDisabled changes
  useEffect(() => {
    if (editor && !editor.isDestroyed) {
      editor.setOptions({ editable: !props.inputDisabled });
    }
  }, [editor, props.inputDisabled]);
    ...
    >
      <div className="px-2.5 pb-1 pt-2">
        ...
        <InputToolbar
          ...
          disabled={isStreaming || !!props.inputDisabled}
        />
      </div>
