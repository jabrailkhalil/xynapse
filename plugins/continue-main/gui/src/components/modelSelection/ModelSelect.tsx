...
function ModelSelect() {
  ...
  console.log("[Xynapse ModelSelect] config.modelsByRole.chat:", config?.modelsByRole?.chat?.length, "isConfigLoading:", isConfigLoading);
  let selectedModel = null;
  let allModels = null;
  let activeRole: string = isInEdit ? "edit" : "chat";
  if (isInEdit) {
