  ...
  return (
    <Listbox>
      <div className="relative" ref={listboxRef}>
        ...
        <Transition>
          <ListboxOptions
            className="max-h-64 scale-x-[97%] overflow-y-auto pb-0"
            style={{ zIndex: 200 }}
          >
            <div className="flex items-center justify-between px-1.5 py-1">
              ...
              <div className="flex items-center gap-0.5">
                ...
                >
                  <CubeIcon className="text-description h-3.5 w-3.5" />
                </Button>
                <Button
                  aria-label="Rules"
                  title="Rules"
                  ...
                  className="my-0 h-5 w-5 p-0"
                >
                  <DocumentTextIcon className="text-description h-3.5 w-3.5" />
                </Button>
                <Button
                  aria-label="Tools"
                  title="Tools"
                  ...
                  className="my-0 h-5 w-5 p-0"
                >
                  <WrenchScrewdriverIcon className="text-description h-3.5 w-3.5" />
                </Button>
                <Button
