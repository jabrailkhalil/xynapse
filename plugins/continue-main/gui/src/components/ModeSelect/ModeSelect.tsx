...
export function ModeSelect() {
  ...
  // Background is a legacy inherited mode; Xynapse uses Chat/Plan/Edit/Full.
  useEffect(() => {
    if (mode === "background") {
      dispatch(setMode("agent"));
    }
    ...
    <Listbox value={mode} onChange={selectMode}>
      <div className="relative">
        ...
        <ListboxOptions className="min-w-32 max-w-48">
          ...
          <ListboxOption value="plan" className={"gap-1"}>
            <div className="flex flex-row items-center gap-1.5">
              ...
              <ToolTip
                ...
                content="Read-only inspection and planning"
              >
          ...
          <ListboxOption value="agent" className={"gap-1"}>
            <div className="flex flex-row items-center gap-1.5">
              ...
              <ToolTip
                ...
                content="Read and edit workspace files"
              >
                <InformationCircleIcon className="h-2.5 w-2.5 flex-shrink-0" />
              </ToolTip>
            </div>
          ...
          <ListboxOption value="full" className={"gap-1"}>
            <div className="flex flex-row items-center gap-1.5">
              <ModeIcon mode="full" />
              ...
              <ToolTip
                ...
                content="Workspace edits plus shell/runtime commands"
              >
                <InformationCircleIcon className="h-2.5 w-2.5 flex-shrink-0" />
              </ToolTip>
            </div>
            <CheckIcon
              className={`ml-auto h-3 w-3 ${mode === "full" ? "" : "opacity-0"}`}
            />
          </ListboxOption>
