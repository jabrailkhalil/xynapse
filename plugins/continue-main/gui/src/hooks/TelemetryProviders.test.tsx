...
vi.mock("../context/Auth", () => ({
  ...
  useAuth: () => ({
    session: {
      account: {
        id: "test@Xynapse.dev", // Mock Xynapse team member email
      },
    },
  }),
}));

// Mock isXynapseTeamMember utility
vi.mock("../util/isXynapseTeamMember", () => ({
  isXynapseTeamMember: vi.fn(() => true), // Mock as Xynapse team member
}));
