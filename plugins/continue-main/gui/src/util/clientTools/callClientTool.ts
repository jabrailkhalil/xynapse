...
import { XynapseError, XynapseErrorReason } from "core/util/errors";
...
export async function callClientTool(
  ...
  try {
    ...
    return {
      ...
      error:
        e instanceof XynapseError
          ? e
          : e instanceof Error
            ? new XynapseError(XynapseErrorReason.Unspecified, e.message)
            : new XynapseError(XynapseErrorReason.Unknown, String(e)),
      output: undefined,
    };
  }
}
