...
import { stabilizeSymbolUpdateActionOrder } from "./streamResponseTestUtils";
...
const mockXynapseModel: ModelDescription = {
...
export function getRootStateWithXynapse(): RootState {
...
describe("streamResponseThunk", () => {
  it("should execute complete streaming flow with all dispatches", async () => {
    const initialState = getRootStateWithXynapse();
    ...
    const dispatchedActions = stabilizeSymbolUpdateActionOrder(
  ...
  it("should execute streaming flow with tool call execution", async () => {
    ...
    const stateWithToolSettings = getRootStateWithXynapse();
    ...
    const dispatchedActions = stabilizeSymbolUpdateActionOrder(
      mockStoreWithToolSettings.getActions(),
    );
  ...
  it("should handle streaming abort", async () => {
    ...
    const abortState = getRootStateWithXynapse();
