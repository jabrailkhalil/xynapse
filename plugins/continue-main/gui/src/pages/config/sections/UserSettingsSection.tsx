...
import { isXynapseTeamMember } from "core/util/isXynapseTeamMember";
...
import { XynapseFeaturesMenu } from "../components/XynapseFeaturesMenu";
              ...
              >
                <div className="flex flex-col gap-x-1 gap-y-4">
                  ...
                  <UserSetting
                    ...
                    description=" Xynapse will not attempt to use native tool calling and will only use system message tools."
                  ...
                  <UserSetting
                    ...
                    description=" streaming will Xynapse after the tool call is rejected."
