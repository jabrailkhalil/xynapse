...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close Xynapse Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Xynapse Sidebar If Chat Already In Focus",
  },
  {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="space-y-6">
        {/* Xynapse settings */}
        <div>
          <h3 className="mb-3 text-base font-medium">Xynapse settings</h3>
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Models"
                description="Configure model roles used by the current Xynapse window"
                icon={CubeIcon}
              ...
              <ConfigRow
                title="Rules"
                description="Configure rules and prompt blocks used by Core and Lab"
              ...
              <ConfigRow
                title="Tools"
                description="Configure tool policies and MCP servers"
              ...
              <ConfigRow
                title="Configs"
                description="Open the local Xynapse configuration list"
                icon={DocumentIcon}
              ...
              <ConfigRow
                title="Preferences"
                description="Adjust chat, autocomplete, and local UI behavior"
                icon={Cog6ToothIcon}
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Open the Xynapse documentation in your browser"
                icon={LinkIcon}
                onClick={() =>
