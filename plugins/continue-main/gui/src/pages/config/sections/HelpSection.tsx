        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Xynapse Hub"
                description="Visit hub.xynapse.dev to explore custom agents and blocks"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://hub.xynapse.dev/")
                }
              />

              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Xynapse"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://docs.xynapse.dev/")
                }
              />
              ...
              <ConfigRow
                ...
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://github.com/xynapse-dev/xynapse/issues/new/choose",
                  )
                }
              />
