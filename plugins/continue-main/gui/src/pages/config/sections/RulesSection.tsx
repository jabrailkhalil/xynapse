import { parseConfigYaml } from "@xynapse/config-yaml";
import {
...
export function RulesSection() {
  return (
    <>
      <ConfigHeader
        title="Rules"
        subtext="These rules are injected into the bottom Xynapse chat and Core runtime prompt when their policy and file filters match."
      />
