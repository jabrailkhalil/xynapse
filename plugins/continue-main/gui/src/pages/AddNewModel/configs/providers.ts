...
export const providers: Partial<Record<string, ProviderInfo>> = {
  yandex_gpt: {
    ...
    packages: [
      models.yandexgptPro5,
      models.yandexgptPro51,
      models.yandexgptLite5,
      models.aliceAiLlm,
      models.aliceAiLlmFlash,
  ...
  anthropic: {
    ...
    tags: [ModelProviderTags.RequiresApiKey],
    longDescription:
      "To get started with Anthropic-compatible models, create an API key in the provider console.",
    collectInputFor: [
      {
        inputType: "text",
        key: "apiKey",
