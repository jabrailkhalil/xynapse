...
export const providers: Partial<Record<string, ProviderInfo>> = {
  yandex_gpt: {
    title: "YandexGPT",
    provider: "yandex_gpt",
    description: "Yandex Cloud AI Studio API",
    longDescription:
      "YandexGPT models from Yandex Cloud. Get API credentials in [Yandex Cloud Console](https://console.yandex.cloud/).",
    icon: "yandexgpt.png",
    ...
    collectInputFor: [
      ...
      },
      {
        ...
        key: "folderId",
        label: "Folder ID",
        placeholder: "Enter your Yandex Cloud Folder ID",
        required: true,
      },
  ...
  gigachat: {
    title: "GigaChat",
    provider: "gigachat",
    description: "Sber GigaChat API",
    longDescription:
      "GigaChat models from Sber. Generate an API key in [GigaChat console](https://developers.sber.ru/studio/workspaces/).",
    icon: "gigachat.png",
    tags: [ModelProviderTags.RequiresApiKey],
    collectInputFor: [
      {
    ...
    packages: [models.gigachat, models.gigachatPlus, models.gigachatPro],
    apiKeyUrl: "https://developers.sber.ru/studio/workspaces/",
  },
  cometapi: {
    title: "CometAPI",
    provider: "cometapi",
  ...
  moonshot: {
    ...
    longDescription: `[Visit our documentation](https://docs.xynapse.dev/reference/Model%20Providers/moonshot) for information on obtaining an API key.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://docs.xynapse.dev/reference/Model%20Providers/azure) for information on obtaining an API key.
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
  ...
  novita: {
    ...
    icon: "novita.png",
    longDescription: `[Novita AI](https://novita.ai?utm_source=xynapse&utm_medium=readme&utm_campaign=xynapse_link) offers an affordable, reliable, and simple inference platform with scalable [LLM APIs](https://novita.ai/docs/model-api/reference/introduction.html), empowering developers to build AI applications. To get started with Novita AI:\n1. Obtain an API key from [here](https://novita.ai/settings/key-management?utm_source=xynapse&utm_medium=readme&utm_campaign=xynapse_link)\n2. Paste below\n3. Select a model preset`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
    ...
    apiKeyUrl:
      "https://novita.ai/settings/key-management?utm_source=xynapse&utm_medium=readme&utm_campaign=xynapse_link",
  },
  gemini: {
  ...
  lemonade: {
    ...
    longDescription:
      "Lemonade provides optimized local LLM inference with support for AMD NPU, GPU, and CPU acceleration. Visit [lemonade-server.ai](https://lemonade-server.ai/) for installation and setup instructions. Once the Lemonade server is running, you can begin using Xynapse with your local models.",
    icon: "lemonade.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    params: {
...
After it's up and running, you can start using Xynapse.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
...
- [llama-cpp-python](https://github.com/xynapse-dev/ggml-server-example)
