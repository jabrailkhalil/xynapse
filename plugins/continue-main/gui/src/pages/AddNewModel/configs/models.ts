...
export const models: { [key: string]: ModelPackage } = {
  ...
  yandexgptLite: {
    ...
    description: "Fast and lightweight Yandex model for autocomplete",
    params: {
  ...
  yandexgptPro: {
    title: "YandexGPT Pro",
    description: "Advanced Yandex model for coding and complex tasks",
    params: {
      model: "yandexgpt-pro",
      contextLength: 8192,
      title: "YandexGPT Pro",
  ...
  yandexgpt32k: {
    title: "YandexGPT 32K",
    description: "Yandex model with extended context window",
    params: {
      model: "yandexgpt-32k",
      contextLength: 32768,
      title: "YandexGPT 32K",
