...
export const models: { [key: string]: ModelPackage } = {
  // ===== Native YandexGPT Models =====
  yandexgptPro5: {
    title: "YandexGPT Pro 5",
    description:
      "Primary YandexGPT model for chat and code editing (32K context)",
    params: {
  ...
  yandexgptPro51: {
    title: "YandexGPT Pro 5.1",
    description: "Current YandexGPT 5.1 model with 32K context",
    params: {
      model: "yandexgpt-5.1",
      contextLength: 32768,
      title: "YandexGPT Pro 5.1",
  ...
  yandexgptLite5: {
    title: "YandexGPT Lite 5",
    description: "Fast lightweight model for autocomplete (32K context)",
    params: {
  ...
  aliceAiLlm: {
    title: "Alice AI LLM",
    description: "Yandex Alice conversational model (128K context)",
    params: {
      model: "aliceai-llm",
  ...
  aliceAiLlmFlash: {
    title: "Alice AI LLM Flash",
    description: "Fast Yandex Alice model with 64K context",
    params: {
  ...
  deepseekV4Flash: {
    ...
    description: "Current DeepSeek coding model with a 1M-token context window",
    params: {
  ...
  qwen3235b: {
    title: "Qwen3 235B",
    description: "Huge 235B parameter model with 256K context for analysis",
    params: {
  ...
  qwen3635b: {
    title: "Qwen3.6 35B",
    description:
      "Current 35B Qwen model on Yandex Cloud with 256K context for coding and analysis",
    params: {
  ...
  gptOss120b: {
    title: "gpt-oss-120b",
    description: "120B parameter model for code review (128K context)",
    params: {
      model: "gpt-oss-120b",
      contextLength: 131072,
      title: "gpt-oss-120b",
  ...
  gptOss20b: {
    title: "gpt-oss-20b",
    description: "Fast 20B parameter model for quick tasks (128K context)",
    params: {
      model: "gpt-oss-20b",
      contextLength: 131072,
      title: "gpt-oss-20b",
  ...
  gigachat: {
    title: "GigaChat",
    description: "Sber GigaChat model",
    params: {
      model: "GigaChat",
      contextLength: 8192,
      title: "GigaChat",
    },
    providerOptions: ["gigachat"],
    icon: "gigachat.png",
    isOpenSource: false,
  },
  gigachatPlus: {
    title: "GigaChat Plus",
    description: "Enhanced GigaChat model for improved quality",
    params: {
      model: "GigaChat-Plus",
      contextLength: 8192,
      title: "GigaChat Plus",
  ...
  gigachatPro: {
    title: "GigaChat Pro",
    description: "Top-tier GigaChat model for advanced reasoning",
    params: {
      model: "GigaChat-Pro",
      contextLength: 8192,
      title: "GigaChat Pro",
