---
title: "Recommended Models for Chat in Xynapse"
description: "Choose the best chat model for Xynapse, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
