---
title: "Recommended Models for Autocomplete in Xynapse"
description: "Choose the best autocomplete model for Xynapse, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, Xynapse supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
