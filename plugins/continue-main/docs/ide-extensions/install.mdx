---
title: "Install"
description: "Get Xynapse installed in your favorite IDE in just a few steps."
---
...
<iframe
  ...
  title="Install Xynapse VS Code Extension"
  frameborder="0"
...
Click `Install` on the [Xynapse extension page in the Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=Xynapse.xynapse)
</Step>

<Step title="Install in VS Code">
  This will open the Xynapse extension page in VS Code, where you will need to
  click `Install` again
</Step>

<Step title="Move to Right Sidebar">
The Xynapse logo will appear on the left sidebar. For a better experience, move Xynapse to the right sidebar
...
<Step title="Sign In">
[Sign in to Mission Control](https://auth.xynapse.dev/) to get started
</Step>
</Steps>
...
<Step title="Find Xynapse Plugin">
  Select **Plugins** on the sidebar and search for "Xynapse" in the marketplace
</Step>

<Step title="Install Plugin">
Click `Install`, which will cause the Xynapse logo to show up on the right toolbar
