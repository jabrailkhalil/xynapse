...
1. Xynapse sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by Xynapse. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/xynapse/xynapse/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
