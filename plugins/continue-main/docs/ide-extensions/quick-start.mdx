...
description: "Learn Xynapse's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Xynapse! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Xynapse's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Xynapse](/ide-extensions/install) and [signed
  in](https://auth.xynapse.dev/) to get started.
</Info>
...
Press **Enter** and watch Xynapse suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Xynapse will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Xynapse refactor your code automatically!
</Step>

<Step title="Review Changes">
Xynapse will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? Xynapse offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Xynapse features. Here's what to explore next:
...
<CardGroup cols={2}>
  ...
  >
    Get help and share experiences with other Xynapse users
  </Card>
</CardGroup>
...
<Info>
  **Need help?** Check our [troubleshooting guide](/troubleshooting) or ask a
  ...
  discussions](https://github.com/xynapse/xynapse/discussions).
</Info>
