---
title: "Xynapse Mission Control"
description: "Your command center for Xynapse. Create Tasks, set up Workflows, manage Agents, connect Integrations, and share with your team—all in one place."
sidebarTitle: "Overview"
---

## What You Can Do in Mission Control

Mission Control is where developers and teams use Xynapse to power everyday coding workflows. From quick one-off Tasks to fully automated pipelines, everything starts here.
...
<CardGroup cols={3}>
  ...
  <Card title="Create a Task" icon="plus" href="https://hub.xynapse.dev">
    Start with a prompt and run an Agent on demand.
  </Card>

  <Card title="Build a Workflow" icon="clock" href="https://hub.xynapse.dev/workflows">
    Automate your Tasks using cron schedules or webhooks.
  </Card>

  <Card title="Add Integrations" icon="workflow" href="https://hub.xynapse.dev/integrations">
