...
## Integrations
<Note>
  Connect Xynapse to your existing developer tools to power Tasks and Workflows.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Slack" icon="slack" href="/mission-control/integrations/slack-agent">
    Mention <code>@Xynapse</code> in Slack to trigger Agents and receive updates.
  </Card>
...
You can go to [Mission Control Integrations](https://hub.xynapse.dev/integrations) for the full list of tools you can connect, or for more information see [the docs page](https://docs.xynapse.dev/mission-control/integrations).
...
<CodeGroup>
    ...
    ```bash yarn
    yarn global add @xynapse/cli
    ```

    ```bash pnpm
    pnpm add -g @xynapse/cli
    ```
...
<CardGroup cols={2}>
  <Card
    title="VS Code"
    icon="code"
    href="https://marketplace.visualstudio.com/items?itemName=Xynapse.xynapse"
  >
  ...
  <Card
    title="JetBrains"
    icon="jet-fighter"
    href="https://plugins.jetbrains.com/plugin/22707-Xynapse-extension"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="comments"
    href="https://github.com/xynapse/xynapse/discussions"
  >
