---
title: "Install Xynapse CLI"
description: "Get Xynapse CLI installed and configured for command-line AI coding assistance and automation"
...
Install Xynapse CLI globally using npm:
...
<Info>
  **Quick Overview**: Xynapse CLI works in two modes - TUI for interactive
...
<Steps>
<Step title="Login to Xynapse CLI">
```bash
cn login
```
This will open your browser to authenticate with Xynapse Mission Control.
</Step>
...
4. Login using your Xynapse account
</Step>
...
<Card title="Create your first workflow" icon="gear" href="/guides/posthog-github-continuous-ai">
  Build automated workflows with Xynapse CLI
</Card>
</CardGroup>
...
- Ask for help in [our discussions](https://github.com/xynapse/xynapse/discussions)
- Report bugs on [GitHub](https://github.com/xynapse/xynapse)
