---
title: "Contributing to Xynapse Documentation"
sidebarTitle: "Docs Contributions"
description: "Welcome to the Xynapse documentation! We're excited that you want to contribute. This guide will help you get started with our documentation workflow and tools."
---
...
<Steps>
  <Step title="Go to GitHub Discussions">
    Visit the [Xynapse GitHub Discussions](https://github.com/xynapse/xynapse/discussions) page.
  </Step>
  ...
  <Step title="Provide detailed information">
    ...
    - Your environment (OS, IDE, Xynapse version)
  </Step>
</Steps>
...
<Info>
  ...
  **Important**: All issues should start as discussions. The Xynapse team will determine if and when a discussion should be escalated to a GitHub issue.
  
</Info>

The Xynapse team will review discussions and may:
...
## 🤖 AI-Powered Documentation with Xynapse

We strongly encourage using Xynapse's AI assistance to maintain consistency and quality in our documentation. Here are three ways to set this up:
...
<Steps>
  <Step title="Install the agent from Xynapse Mission Control">
    Visit [the Docs Assistant - Mintlify in Mission Control](https://hub.xynapse.dev/xynapse/docs-mintlify) and click "Install" to add it to your Xynapse setup. This agent comes pre-configured with all our documentation standards.

    <Info>
    Learn more about Xynapse Configs in our [config documentation](/guides/understanding-configs).
    </Info>
  </Step>
  ...
  <Step title="Use the agent">
    <Tabs>
      <Tab title="Command Line">
        ```bash
        # Install the Xynapse CLI if you haven't already
        npm install -g @xynapse/cli
        
        # Use the agent from the command line
        cn "Create a new guide for using the Xynapse CLI with Linear" --config xynapse/docs-mintlify
        ```
      </Tab>
      
      <Tab title="IDE">
        1. Open Xynapse in your IDE
        2. Select the "Docs Assistant - Mintlify" agent from the model dropdown
        3. Ask it to help you create or edit documentation
        
        Example prompts:
        - "Create a new guide for using the Xynapse CLI with Linear"
...
<Steps>
  ...
  <Step title="Add the Xynapse Docs MCP">
    Install from Xynapse Mission Control: https://hub.xynapse.dev/xynapse/xynapse-docs-mcp
    
    This MCP provides context about Xynapse's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from Xynapse Mission Control: https://hub.xynapse.dev/mintlify/technical-writing-rule
...
2. Add frontmatter:
   ...
   ---
   ```
3. Use the Xynapse agent to help format your content
...
1. Use the Xynapse agent with prompts like:
...
3. **Format check**: Use the Xynapse agent to validate Mintlify formatting
...
- **Use the Xynapse agent**: It knows our documentation standards and will save you time
...
- **Start a Discussion**: Use [GitHub Discussions](https://github.com/xynapse/xynapse/discussions) for documentation issues, suggestions, or questions
- **Xynapse agent questions**: Check the [Xynapse Mission Control page](https://hub.xynapse.dev/xynapse/docs-mintlify)
- **Discord community**: Join our Discord for real-time help
- **Existing docs**: Review similar pages for formatting examples
---

Thank you for contributing to Xynapse! Your efforts help make our documentation better for everyone. To learn more about contibuting to other parts of the project, check out our [main CONTRIBUTING guide](https://github.com/xynapse/xynapse/blob/main/CONTRIBUTING.md) 🎉
