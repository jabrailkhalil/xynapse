...
<Tip>
  **Discover Mistral models [here](https://hub.xynapse.dev/mistral)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.xynapse.dev/mistral/codestral?view=config)**
</Info>
