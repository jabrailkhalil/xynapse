...
<Tip>
  **Discover Ask Sage models [here](https://hub.xynapse.dev/hub?q=Ask%20Sage)**
</Tip>
...
Add your Ask Sage model to your Xynapse configuration file.
...
- Restart Xynapse to apply changes.

Your Ask Sage model will now be available in Xynapse.
