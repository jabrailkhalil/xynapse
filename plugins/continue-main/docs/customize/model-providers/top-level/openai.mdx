---
title: "How to Configure OpenAI Models with Xynapse"
slug: ../openai
sidebarTitle: "OpenAI"
---

<Tip>
  **Discover OpenAI models [here](https://hub.xynapse.dev/openai)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.xynapse.dev/openai/gpt-5?view=config)**
</Info>
