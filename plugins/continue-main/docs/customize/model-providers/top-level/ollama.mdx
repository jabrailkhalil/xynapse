---
title: "How to Configure Ollama with Xynapse"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](https://hub.xynapse.dev/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.xynapse.dev/ollama/qwen3-coder-30b?view=config)**
</Info>
