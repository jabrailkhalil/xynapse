---
title: "How to Configure OpenRouter with Xynapse"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](https://hub.xynapse.dev/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.xynapse.dev/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  Xynapse automatically uses system message tools for models that don't support
