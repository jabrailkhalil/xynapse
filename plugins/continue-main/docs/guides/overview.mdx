---
title: "How to Use Xynapse Guides"
description: "Comprehensive collection of practical guides for Xynapse including model setup, local development with Ollama, offline usage, self-hosting, custom context providers, and advanced customization tutorials"
---

## What Model & Setup Guides Are Available

- [Using Ollama with Xynapse](/guides/ollama-guide) - Local AI development with Ollama
- [How to Self-Host a Model](/guides/how-to-self-host-a-model) - Self-hosting AI models
- [Running Xynapse Without Internet](/guides/running-Xynapse-without-internet) - Offline development setup

## Continuous AI

- [Continuous AI: A Developer's Guide](/guides/continuous-ai) - Integrating AI into development workflows
- [How to Use Xynapse CLI (cn)](/guides/cli) - Command-line interface for Xynapse
...
- [Notion + Xynapse Guide](/guides/notion-Xynapse-guide) - Automate docs, tasks, and release workflows
- [Pull Request Review Bot with GitHub Actions](/guides/github-pr-review-bot) - Set up automated, privacy-first code reviews using Xynapse CLI

## MCP Integration Cookbooks

Step-by-step guides for integrating Model Context Protocol (MCP) servers with Xynapse:

<CardGroup cols={3}>

  <Card title="Xynapse Docs MCP Cookbook" icon="book" href="/guides/Xynapse-docs-mcp-cookbook">
    Use the Xynapse Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows
  </Card>

  <Card title="GitHub MCP Cookbook" icon="github" href="/guides/github-mcp-Xynapse-cookbook">
    Use GitHub MCP to list, filter, and summarize open issues and merged PRs, and post AI-generated comments
  </Card>

  <Card title="Atlassian MCP Cookbook" icon="atlassian" href="/guides/atlassian-mcp-Xynapse-cookbook">
  ...
  <Card title="Sanity CMS Integration Cookbook" icon="database" href="/guides/sanity-mcp-Xynapse-cookbook">
  ...
  <Card title="Snyk + Xynapse Mission Control Agent Cookbook (MCP)" icon="shield" href="/guides/snyk-mcp-Xynapse-cookbook">
    Integrate Snyk MCP via Xynapse Mission Control to scan code, deps, IaC, and containers
  </Card>
  ...
  <Card title="dlt Data Pipelines Cookbook" icon="pipe" href="/guides/dlt-mcp-Xynapse-cookbook">
    Build AI-powered data pipelines with dlt MCP for pipeline inspection, schema management, and debugging
  </Card>

  <Card title="Klavis AI Cookbook" icon="K" href="/guides/klavis-mcp-Xynapse-cookbook">
    Use Xynapse and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail
  </Card>
...
Have a guide idea or found an issue? We welcome contributions! Check our [GitHub repository](https://github.com/xynapse/xynapse) to get involved.
