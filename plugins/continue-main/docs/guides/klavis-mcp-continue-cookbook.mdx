---
title: "Slack and Gmail Automation with Klavis AI Strata MCP and Xynapse"
description: "Use Xynapse and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail with natural language prompts."
sidebarTitle: "Klavis AI with Xynapse"
---

<Card title="What You'll Build" icon="wand-magic-sparkles">
  A communication workflow assistant that uses Xynapse CLI with Klavis AI's Strata MCP to manage and automate multi-platform workflows including Slack and Gmail—all through simple natural language prompts.
</Card>
...
<Tabs>
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on Xynapse Hub">
        Go to the [Xynapse Hub](https://hub.xynapse.dev) and [create a new agent](https://hub.xynapse.dev/new?type=agent).
      </Step>
    ...
    <Info>
      **Pro tip**: Learn how to integrate and use [Klavis Strata](https://www.klavis.ai/docs/knowledge-base/use-mcp-server/Xynapse) with Xynapse through CLI and IDE.
    </Info>
  ...
  <Tab title="CLI Setup">
    <Steps>
      ...
      <Step title="Launch Xynapse with Klavis MCP">
        ...
        Now try:
        ```
        "Send a Slack message to #general saying 'Hello from Xynapse!'"
        ```
      </Step>
    </Steps>
  </Tab>
...
<Accordion title="Agent Requirements">
  To use Klavis AI Strata MCP with Xynapse CLI, you need either:
  - **Xynapse CLI Pro Plan** with the models add-on, OR
  - **Your own API keys** added to Xynapse Hub secrets
...
<CardGroup cols={2}>
  ...
  <Card title="MCP in Xynapse" icon="puzzle-piece" href="/customize/deep-dives/mcp">
    Learn how MCP works with Xynapse agents
  </Card>
  <Card title="Xynapse Hub" icon="globe" href="https://hub.xynapse.dev">
    Create and manage your Xynapse agents
  </Card>
</CardGroup>