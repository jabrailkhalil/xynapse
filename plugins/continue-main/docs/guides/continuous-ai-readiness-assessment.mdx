...
<CardGroup cols={2}>
  <Card
    title="Building Async Agents with Xynapse CLI"
    icon="blog"
    href="https://blog.xynapse.dev/building-async-agents-with-Xynapse-cli/"
  >
  ...
  <Card
    ...
    icon="book"
    href="https://docs.xynapse.dev/guides/continuous-ai"
  >
