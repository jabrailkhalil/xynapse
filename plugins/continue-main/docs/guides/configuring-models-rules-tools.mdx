...
description: "Learn how to work with Xynapse's configuration system. Understand how to use hub models, rules, and tools, create local configurations, and organize your setup for maximum reusability."
---

## What Are Models, Rules, and Tools?

Xynapse configs are built from three main types of configuration:
...
Pre-built models, rules, and tools from the Xynapse community that you can import and use immediately
</Card>
</Columns>
...
Xynapse hub uses a slug in the format of `owner/item-name` to resolve blocks.

For example, to use the [Claude 4 Sonnet model](https://hub.xynapse.dev/anthropic/claude-4-sonnet), you'd reference it as `anthropic/claude-4-sonnet`.
...
- **[Xynapse Mission Control](https://hub.xynapse.dev)**: Browse community models, rules, and tools
