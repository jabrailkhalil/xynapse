...
Rules guide agent mode's behavior and understanding. Place markdown files in `.xynapse/rules` in your project to provide context:
...
[DeepWiki MCP](https://hub.xynapse.dev/deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](https://hub.xynapse.dev/upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
...
2. **Add rules**: Create `.xynapse/rules` files to provide context about your project structure
...
The new approach provides better integration with Xynapse's Agent mode features and more intelligent context selection.

## Next steps

- Learn more about [MCP servers](/reference/Xynapse-mcp)
