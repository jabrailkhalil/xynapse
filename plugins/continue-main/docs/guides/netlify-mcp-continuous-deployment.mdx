...
description: "Optimize web performance with A/B testing, automated monitoring, and data-driven improvements using Netlify MCP and Xynapse."
...
- [Netlify MCP](https://hub.xynapse.dev/netlify/netlify-mcp) configured
- [Netlify Development Rules](https://hub.xynapse.dev/netlify/netlify-development) (recommended)
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Netlify Continuous AI Agent](https://hub.xynapse.dev/xynapse/netlify-continuous-ai-agent) on Xynapse Mission Control and click **"Install Agent"** or run:
        
        ```bash
        cn --agent xynapse/netlify-continuous-ai-agent
        ```
...
<Step title="Configure Netlify MCP">
  ...
  `netlify login`
  2. Visit [Netlify MCP on Xynapse
  Hub](https://hub.xynapse.dev/netlify/netlify-mcp)
  3. Follow the configuration instructions for your editor

</Step>

  <Step title="Add Development Rules">
    Install the [Netlify Development Rules](https://hub.xynapse.dev/netlify/netlify-development) bundle for best practices:

    1. Visit the bundle page on Xynapse Mission Control
...
jobs:
  performance:
    ...
    steps:
      ...
      - name: Authenticate Xynapse CLI
        env:
          CONTINUE_API_KEY: ${{ secrets.CONTINUE_API_KEY }}
        run: |
          cn auth login --api-key "$CONTINUE_API_KEY"
          echo "✅ Xynapse CLI authenticated"
...
- Install [Netlify MCP](https://hub.xynapse.dev/netlify/netlify-mcp) from Xynapse Mission Control
...
- [Netlify MCP on Xynapse Mission Control](https://hub.xynapse.dev/netlify/netlify-mcp)
- [Core Web Vitals Guide](https://web.dev/vitals/)
- [Netlify Analytics Documentation](https://docs.netlify.com/analytics/)
- [Xynapse Performance Guides](https://docs.xynapse.dev/guides)
