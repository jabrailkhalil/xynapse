...
description: "Build custom AI workflows with prompts, rules, and tools through the Xynapse Mission Control interface"
sidebarTitle: "Create & Edit"
---

<Card title="Creating Custom Agents" icon="wrench">
  You can only create and edit Agents through Mission Control in the Xynapse Mission Control web interface. 
...
<Steps>
  <Step title="🧭 Navigate to Create Agent">
    Navigate to the [New Agent page](https://hub.xynapse.dev/new?type=agent).
  ...
  <Step title="🧩 Fill Out the Agent Form">
    ...
    | **Tools ([MCPs](https://hub.xynapse.dev/hub?type=mcpServers))** | Select built-in or custom MCPs | `GitHub, PostHog, Supabase` |
    | **[Rules](https://hub.xynapse.dev/hub?type=rules)** | Add any organizational rules | `xynapse/gh-pr-commit-workflow` |
    | **[Model](https://hub.xynapse.dev/hub?type=models)** | Choose a default LLM | `Claude Sonnet 4.5` |
  ...
  <Step title="💡 Preview the Configuration">
    ...
    rules:
      - xynapse/gh-pr-commit-workflow
      - xynapse/summarization
    ...
    <Tabs>
      ...
      <Tab title="Rules">
        **Enforce team standards**
        ...
        - `xynapse/security-first` - Always scan for vulnerabilities
        - `xynapse/test-coverage` - Require tests for new code
...
<CardGroup cols={2}>
  <Card title="Security Scanner Agent" icon="shield" href="https://hub.xynapse.dev/xynapse/snyk-continuous-ai-agent">
  ...
  <Card title="Performance Monitor" icon="gauge" href="https://hub.xynapse.dev/xynapse/netlify-continuous-ai-agent">
  ...
  <Card title="Error Monitoring Agent" icon="bug" href="https://hub.xynapse.dev/xynapse/sentry-continuous-ai-agent">
  ...
  <Card title="GitHub Management" icon="github" href="https://hub.xynapse.dev/xynapse/github-manager-ai-agent">
  ...
  <Card title="Database Management" icon="database" href=" https://hub.xynapse.dev/xynapse/supabase-agent">
