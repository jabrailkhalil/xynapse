...
- **Security & compliance** - [Automated vulnerability scanning](../guides/snyk-mcp-Xynapse-cookbook)
...
<Steps>
  <Step title="Access Mission Control">
    Go to [Mission Control Agents](https://hub.xynapse.dev/hub?type=agents) and connect with your GitHub account.
...
Before creating your own agent, let's see one in action! The fastest way to experience the power of Xynapse agents is with our demo repository.
...
<Steps>
  <Step title="🍴 Fork Our Demo Repository">
    ...
    **Option 1: GitHub Web Interface**
    Visit [github.com/xynapse/demo-project](https://github.com/xynapse/demo-project) and click **Fork**
    
    **Option 2: GitHub CLI**
    ```bash
    gh repo fork xynapse/demo-project
    ```
  </Step>

  <Step title="🎯 Access Mission Control">
    Go to [Mission Control Agents](https://hub.xynapse.dev/hub?type=agents) and:
    - **Connect GitHub** and authorize Xynapse when prompted
...
<Tabs>
  <Tab title="🌐 Mission Control">
    **Web interface for interactive use**
    ...
    Access at [hub.xynapse.dev/agents](https://hub.xynapse.dev/hub?type=agents)
  </Tab>
  ...
  <Tab title="🤖 Headless Mode">
    **Automated execution for CI/CD**
    ...
    ```bash
    cn --agent xynapse/snyk-continuous-ai-agent -p "Run security scan" --auto
    ```
...
<CardGroup cols={2}>
  <Card title="Start Small" icon="seedling">
    Begin with tasks you're confident Xynapse can handle, like fixing known bugs with simple solutions.
  </Card>
  
  <Card title="Practice Locally" icon="terminal">
    Test with [Xynapse CLI](../guides/cli) in TUI mode before deploying automation.
  </Card>
...
<Info>
  **Learn More**: Explore advanced patterns and case studies on the [Continuous AI Blog](https://blog.xynapse.dev).
</Info>
