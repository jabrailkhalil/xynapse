...
export interface Config {
  /** If set to true, Xynapse will collect anonymous usage data to improve the product. If set to false, we will collect nothing. Read here to learn more: https://docs.xynapse.dev/telemetry */
  allowAnonymousTelemetry?: boolean;
