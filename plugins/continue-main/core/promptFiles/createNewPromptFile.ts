...
# It is used to define and reuse prompts within Xynapse
...
# To learn more, see the full .prompt file reference: https://docs.xynapse.dev/features/prompt-files
name: Example
