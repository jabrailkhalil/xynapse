...
import { IXynapseServerClient } from "../../xynapseServer/interface";
...
export const testXynapseServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IXynapseServerClient;

const mockXynapseServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IXynapseServerClient;
