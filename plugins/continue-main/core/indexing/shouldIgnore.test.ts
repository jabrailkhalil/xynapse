...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .xynapseignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".xynapseignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .xynapseignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".xynapseignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.xynapseignore", "level3/"],
    ]);
    const result = await shouldIgnore(
