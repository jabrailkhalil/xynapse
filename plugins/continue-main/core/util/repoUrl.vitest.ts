...
describe("normalizeRepoUrl", () => {
  ...
  describe("case normalization", () => {
    ...
    it("should handle mixed case in shorthand format", () => {
      expect(normalizeRepoUrl("XynapseDev/Xynapse")).toBe(
        "https://github.com/xynapsedev/xynapse",
      );
    });
  });
  ...
  describe("real-world examples", () => {
    it("should normalize Xynapse's repository from SSH", () => {
      expect(normalizeRepoUrl("git@github.com:jabrailkhalil/Xynapse.git")).toBe(
        "https://github.com/jabrailkhalil/xynapse",
      );
    });

    it("should normalize Xynapse's repository from shorthand", () => {
      expect(normalizeRepoUrl("jabrailkhalil/Xynapse")).toBe(
        "https://github.com/jabrailkhalil/xynapse",
      );
    });

    it("should normalize Xynapse's repository from HTTPS", () => {
      expect(
        normalizeRepoUrl("https://github.com/jabrailkhalil/Xynapse.git"),
      ).toBe("https://github.com/jabrailkhalil/xynapse");
    });

    it("should match repositories regardless of input format", () => {
      const formats = [
        "git@github.com:jabrailkhalil/Xynapse.git",
        "jabrailkhalil/Xynapse",
        "https://github.com/jabrailkhalil/Xynapse",
        "https://github.com/jabrailkhalil/Xynapse.git",
        "ssh://git@github.com/jabrailkhalil/Xynapse.git",
      ];

      const expected = "https://github.com/jabrailkhalil/xynapse";
