...
export class XynapseError extends Error {
  reason: XynapseErrorReason;

  constructor(reason: XynapseErrorReason, message?: string) {
    super(message);
    this.reason = reason;
    this.name = "XynapseError";
  }
}

export enum XynapseErrorReason {
