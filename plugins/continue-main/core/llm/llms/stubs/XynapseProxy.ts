...
class XynapseProxy extends OpenAI {
  ...
  // This identifier is part of the Continue control-plane wire protocol.
  // Keep it stable even though the local product is branded Xynapse.
  ...
  private _getUserAgent(): string {
    ...
    return `Xynapse/${extensionVersion} (${ideName}; ${ideType})`;
  }
