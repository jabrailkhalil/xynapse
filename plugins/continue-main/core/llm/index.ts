...
export abstract class BaseLLM implements ILLM {
  ...
  constructor(_options: LLMOptions) {
    ...
    // Use @xynapse/llm-info package to autodetect certain parameters
  ...
  private _modifyCompletionOptions(
    ...
    // See these threads:
    // - https://github.com/jabrailkhalil/Xynapse/issues/3698
  ...
  async *streamChat(
    ...
    /*
      TODO: Verify extended-thinking behavior against the active provider docs.
