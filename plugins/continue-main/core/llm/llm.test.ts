...
// These are paid, provider-backed integration tests. Keeping them in the unit
// suite caused normal local and CI runs to make network requests with empty API
// keys. They remain available explicitly for release verification.
const describeLive =
  process.env.RUN_LIVE_LLM_TESTS === "1" ? describe : describe.skip;

describeLive("LLM live providers", () => {
