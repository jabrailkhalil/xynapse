...
export const lsTool: Tool = {
  type: "function",
  displayTitle: "ls",
  wouldLikeTo: "list files in workspace path {{{ dirPath }}}",
  isCurrently: "listing files in workspace path {{{ dirPath }}}",
  hasAlready: "listed files in workspace path {{{ dirPath }}}",
  readonly: true,
  isInstant: true,
    ...
    parameters: {
      ...
      properties: {
        dirPath: {
          type: "string",
          description:
            "The directory path. Use . for the opened workspace root. Can be relative to project root, absolute path, tilde path (~/...), or file:// URI. Use forward slash paths",
        },
        recursive: {
          type: "boolean",
          description:
