...
# To learn more, see the full config.yaml reference: https://docs.xynapse.dev/reference
...
# https://docs.xynapse.dev/customization/models
models:
  - name: my gpt-5
    provider: openai
    model: gpt-5
...
# MCP Servers that Xynapse can access
# https://docs.xynapse.dev/customization/mcp-tools
mcpServers:
