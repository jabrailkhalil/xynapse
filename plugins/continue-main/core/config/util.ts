...
import { ModelConfig } from "@xynapse/config-yaml";
import {
  XynapseConfig,
...
async function showUnsupportedCpuToast(ide: IDE) {
  ...
  if (shouldOpenLink) {
    void ide.openUrl(
      "https://docs.xynapse.dev/troubleshooting#i-received-a-codebase-indexing-disabled---your-linux-system-lacks-required-cpu-features-avx2-fma-notification",
    );
  }
}
