...
import {
  getAllDotXynapseDefinitionFiles,
  LoadAssistantFilesOptions,
} from "./loadLocalAssistants";
describe("ASSISTANTS getAllDotXynapseDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
    ...
    addToTestDir([
      ".xynapse/assistants/",
      [".xynapse/assistants/assistant1.yaml", "yaml content 1"],
      [".xynapse/assistants/assistant2.yml", "yaml content 2"],
      [".xynapse/assistants/assistant3.md", "markdown content 1"],
      [".xynapse/assistants/assistant4.txt", "txt content"],
      [".xynapse/assistants/config.yaml", "txt content"],
      [".xynapse/assistants/config.yml", "txt content"],
    ]);
  });
  ...
  it("should return only YAML files when fileExtType is 'yaml'", async () => {
    ...
    const result = await getAllDotXynapseDefinitionFiles(
      testIde,
      options,
      "assistants",
    );
  ...
  it("should respect includeWorkspace option with fileExtType", async () => {
    ...
    const noWorkspaceResult = await getAllDotXynapseDefinitionFiles(
      testIde,
      workspaceOffOptions,
      "assistants",
    );
    ...
    const workspaceResult = await getAllDotXynapseDefinitionFiles(
      testIde,
      workspaceOnOptions,
      "assistants",
    );
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".xynapse/assistants/",
      [".xynapse/assistants/nonmatch1.txt", "txt content"],
      [".xynapse/assistants/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    addToTestDir([
      [".xynapse/assistants/assistant5.YAML", "uppercase yaml"],
      [".xynapse/assistants/assistant6.YML", "uppercase yml"],
      [".xynapse/assistants/assistant7.MD", "uppercase md"],
    ]);
    ...
    const yamlResult = await getAllDotXynapseDefinitionFiles(
      testIde,
      yamlOptions,
      "assistants",
    );
    ...
    const markdownResult = await getAllDotXynapseDefinitionFiles(
      testIde,
      markdownOptions,
      "assistants",
    );
...
describe("AGENTS getAllDotXynapseDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
    walkDirCache.invalidate();
    ...
    addToTestDir([
      ".xynapse/agents/",
      [".xynapse/agents/agent1.yaml", "yaml content 1"],
      [".xynapse/agents/agent2.yml", "yaml content 2"],
      [".xynapse/agents/agent3.md", "markdown content 1"],
      [".xynapse/agents/agent4.txt", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".xynapse/agents/",
      [".xynapse/agents/nonmatch1.txt", "txt content"],
      [".xynapse/agents/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    // Add files with uppercase extensions
    addToTestDir([
      [".xynapse/agents/agent5.YAML", "uppercase yaml"],
      [".xynapse/agents/agent6.YML", "uppercase yml"],
      [".xynapse/agents/agent7.MD", "uppercase md"],
    ]);
