...
export const EXTENSION_NAME = "xynapse";
...
const PRODUCTION_HUB_ENV: ControlPlaneEnv = {
  DEFAULT_CONTROL_PLANE_PROXY_URL: "https://api.xynapse.dev/",
  CONTROL_PLANE_URL: "https://api.xynapse.dev/",
  AUTH_TYPE: AuthType.WorkOsProd,
  WORKOS_CLIENT_ID: WORKOS_CLIENT_ID_PRODUCTION,
  APP_URL: "https://hub.xynapse.dev/",
};

const STAGING_ENV: ControlPlaneEnv = {
  DEFAULT_CONTROL_PLANE_PROXY_URL: "https://api.xynapse-stage.tools/",
  CONTROL_PLANE_URL: "https://api.xynapse-stage.tools/",
  AUTH_TYPE: AuthType.WorkOsStaging,
  WORKOS_CLIENT_ID: WORKOS_CLIENT_ID_STAGING,
  APP_URL: "https://hub.xynapse-stage.tools/",
};

const TEST_ENV: ControlPlaneEnv = {
  DEFAULT_CONTROL_PLANE_PROXY_URL: "https://api-test.xynapse.dev/",
  CONTROL_PLANE_URL: "https://api-test.xynapse.dev/",
  AUTH_TYPE: AuthType.WorkOsStaging,
  WORKOS_CLIENT_ID: WORKOS_CLIENT_ID_STAGING,
  APP_URL: "https://app-test.xynapse.dev/",
};
...
export async function enableHubXynapseDev() {
  return true;
}
...
export async function getControlPlaneEnv(
  ...
  return getControlPlaneEnvSync(ideSettings.xynapseTestEnvironment);
}

export function getControlPlaneEnvSync(
  ideTestEnvironment: IdeSettings["xynapseTestEnvironment"],
): ControlPlaneEnv {
  // MDM override
...
export async function useHub(
  ...
  const ideSettings = await ideSettingsPromise;
  return ideSettings.xynapseTestEnvironment !== "none";
}
