...
class XynapseProxyContextProvider extends BaseContextProvider {
  static description: ContextProviderDescription = {
    title: "Xynapse-proxy",
    displayTitle: "Xynapse Proxy",
    description: "Retrieve a context item from a Xynapse for Teams add-on",
    type: "submenu",
  };
  ...
  override get description(): ContextProviderDescription {
    return {
      title:
        this.options.title || XynapseProxyContextProvider.description.title,
      displayTitle:
        this.options.displayTitle ||
        this.options.name ||
        XynapseProxyContextProvider.description.displayTitle,
      description:
        this.options.description ||
        XynapseProxyContextProvider.description.description,
      type: this.options.type || XynapseProxyContextProvider.description.type,
    };
  }
...
export default XynapseProxyContextProvider;
