"""Council agent definitions - 4 roles for free-form project planning."""
...
AGENT_PROMPTS = {
    "PM": (
        ...
        "Твои задачи:\n"
        "- Уточнить требования пользователя и превратить их в четкое ТЗ\n"
...
def create_agents(
    ...
    """Create the 4 free-form Council agents with their respective models."""
