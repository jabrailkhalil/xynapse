...
export type FileIconClone = CustomClone & Pick<FileIcon, 'fileExtensions' | 'fileNames'>;
export type LanguageIconClone = CustomClone & Pick<LanguageIcon, 'ids'>;
export type FolderIconClone = CustomClone & Pick<FolderIcon, 'folderNames' | 'rootFolderNames'>;
