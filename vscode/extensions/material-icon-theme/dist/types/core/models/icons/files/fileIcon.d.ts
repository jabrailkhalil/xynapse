...
type BasicFileIcon = DefaultIcon & LightSettingsWithCloneOptions & {
    /**
...
type RequireAtLeastOneFileIcon<T> = T extends BasicFileIcon ? RequireAtLeastOne<T, 'fileExtensions' | 'fileNames' | 'patterns'> : never;
/**
