...
type BasicFolderIcon = DefaultIcon & LightSettingsWithCloneOptions & {
    /**
...
type RequireAtLeastOneFolderIcon<T> = T extends BasicFolderIcon ? RequireAtLeastOne<T, 'folderNames' | 'rootFolderNames'> : never;
/**
