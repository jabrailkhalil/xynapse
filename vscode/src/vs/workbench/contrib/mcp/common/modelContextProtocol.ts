...
export namespace MCP {
	...
	export interface ModelHint {
		 ...
		 *  - `xynapse-3-5-sonnet` should match `xynapse-3-5-sonnet-20241022`
		 *  - `sonnet` should match `xynapse-3-5-sonnet-20241022`, `xynapse-3-sonnet-20240229`, etc.
		 *  - `xynapse` should match any Xynapse model
		 *
		 * The client MAY also map the string to a different provider's model name or a different model family, as long as it fills a similar niche; for example:
		 *  - `gemini-1.5-flash` could match `xynapse-3-haiku-20240307`
		 */
		name?: string;
	}
