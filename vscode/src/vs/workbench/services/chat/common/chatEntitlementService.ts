...
export class ChatEntitlementContext extends Disposable {
	...
	constructor(
		...
		// Xynapse: Auto-enable chat functionality without requiring Copilot login
		// This allows YandexGPT and other local language model providers to work immediately
