...
const compilations = [
	...
	// 'extensions/tunnel-forwarding/tsconfig.json', // Xynapse: removed
	'extensions/typescript-language-features/web/tsconfig.json',
	'extensions/typescript-language-features/tsconfig.json',
	// 'extensions/vscode-api-tests/tsconfig.json', // Xynapse: removed
	// 'extensions/vscode-colorize-tests/tsconfig.json', // Xynapse: removed
	// 'extensions/vscode-colorize-perf-tests/tsconfig.json', // Xynapse: removed
	// 'extensions/vscode-test-resolver/tsconfig.json', // Xynapse: removed
